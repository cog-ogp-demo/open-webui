...
export default function OrderSuccess({ token, order, onNewOrder }: OrderSuccessProps) {
		...
		<div className="space-y-6">
				...
				<div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
					...
					{order.payOrderQrCodeUrl && (
						<div className="text-center">
							...
							/>
							<p className="text-xs text-yellow-600 mt-2">Scan with WeChat to pay</p>
						</div>
					)}
			...
			{!order.needPay && (
				<div className="p-4 bg-green-50 border border-green-200 rounded-lg text-center">
					<p className="text-green-700 font-medium">No payment needed - Coupon applied!</p>
				</div>
			)}
